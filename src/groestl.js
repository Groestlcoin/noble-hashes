...
//const {groestl} = require("../groestl");

var T0 = h.bytes2Int64Buffer(
  h.b64Decode(
...
var B64 = function (n, x) {
  ...
  if (bits >= 32) {
    ...
    const bitsOff32 = 32 - bits,
      toMoveDown = (x.hi << bitsOff32) >>> bitsOff32; // was this.hi, not x.hi
...
var nj64 = [
  o.u(0xffffffff, 0xffffffff),
  o.u(0xffffffff, 0xffffffef),
  o.u(0xffffffff, 0xffffffdf),
  o.u(0xffffffff, 0xffffffcf),
  o.u(0xffffffff, 0xffffffbf),
  o.u(0xffffffff, 0xffffffaf),
  o.u(0xffffffff, 0xffffff9f),
  o.u(0xffffffff, 0xffffff8f),
  o.u(0xffffffff, 0xffffff7f),
  o.u(0xffffffff, 0xffffff6f),
  o.u(0xffffffff, 0xffffff5f),
  o.u(0xffffffff, 0xffffff4f),
  o.u(0xffffffff, 0xffffff3f),
  o.u(0xffffffff, 0xffffff2f),
  o.u(0xffffffff, 0xffffff1f),
  o.u(0xffffffff, 0xffffff0f),
];
...
module.exports.groestlSingle = function (ctx, data, len) {
  return groestlS(ctx, data, len);
};

var groestlS = function (ctx, data, len) {
  var buf, ptr;
...
module.exports.groestlClose = function (ctx) {
  var buf = ctx.buffer;
  var ptr = ctx.ptr;
...
module.exports.groestlHash = function (input, format, output) {
  var msg;
  if (format === 1) {
    msg = input;
  } else if (format === 2) {
